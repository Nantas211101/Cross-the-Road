...
void LaneFactoryTheme3::templateLevelFinish1(int num){
    for(int i = 0; i < num; i++) {
...
void LaneFactoryTheme3::templateLevelFinish2(int num){
    for(int i = 0; i < num; i++) {
...
void LaneFactoryTheme3::templateLevelFinish3(int num){
    for(int i = 0; i < num; i++) {
